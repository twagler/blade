...
QuadTree::QuadTree()
{
    ...
    LawnCoordinate leafNW = null;
    LawnCoordinate leafNE = null;
    LawnCoordinate leafSW = null;
    LawnCoordinate leafSE = null;
...
void QuadTree::build(std::vector<std::vector<LawnCoordinate>> vList) {
    ...
    //x starts at 0 but size is 1, plus need to check ahead one since we're grabbing 2 at a time.
